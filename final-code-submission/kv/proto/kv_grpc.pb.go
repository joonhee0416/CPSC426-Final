...
type KvClient interface {
	...
	TmpSet(ctx context.Context, in *TmpSetRequest, opts ...grpc.CallOption) (*TmpSetResponse, error)
...
func (c *kvClient) TmpSet(ctx context.Context, in *TmpSetRequest, opts ...grpc.CallOption) (*TmpSetResponse, error) {
	out := new(TmpSetResponse)
	err := c.cc.Invoke(ctx, "/kv.Kv/TmpSet", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type KvServer interface {
	...
	TmpSet(context.Context, *TmpSetRequest) (*TmpSetResponse, error)
...
func (UnimplementedKvServer) TmpSet(context.Context, *TmpSetRequest) (*TmpSetResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method TmpSet not implemented")
}
...
func _Kv_TmpSet_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(TmpSetRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(KvServer).TmpSet(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/kv.Kv/TmpSet",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(KvServer).TmpSet(ctx, req.(*TmpSetRequest))
	}
	return interceptor(ctx, in, info, handler)
}
